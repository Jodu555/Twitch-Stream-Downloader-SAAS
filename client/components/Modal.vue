<template>
    <div class="modal fade" v-on="{ 'hide.bs.modal': () => changeShow(false), 'show.bs.modal': () => changeShow(true) }"
        :id="id" tabindex="-1" aria-labelledby="" aria-hidden="true" ref="modalElement">
